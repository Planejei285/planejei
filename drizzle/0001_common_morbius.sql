CREATE TABLE `plannerData` (
	...
	CONSTRAINT `plannerData_id` PRIMARY KEY(`id`)
);
...
--> statement-breakpoint
ALTER TABLE `plannerData` ADD CONSTRAINT `plannerData_userId_users_id_fk` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
